...
class GazeHead(nn.Module):
    """
    GazeHead: Takes backbone features and predicts pitch and yaw.
    This head uses two separate fully-connected layers for pitch and yaw,
    outputting binned predictions for a classification approach.
    ...
    def __init__(self, in_channels, num_bins):
        ...
        # Separate linear layers for pitch and yaw
    ...
    def forward(self, x):
        ...
        pitch = self.fc_pitch(x)  # [B, num_bins]
        yaw = self.fc_yaw(x)      # [B, num_bins]
