...
root = "/home/tanerijun/gaze-tracker-model/data/raw/Gaze360/" # input dataset path
out_root = "/home/tanerijun/gaze-tracker-model/data/preprocessed/Gaze360" # output path
