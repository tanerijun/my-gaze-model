...
def main() -> None:
        ...
        aggregate_rows.append(
            {
                "session_id": session_id,
                "status": "ok",
                "run_eval_mode": args.eval_mode,
                "run_time_mapping": args.time_mapping,
                "run_device": args.device,
                "run_context_frames": args.context_frames,
                "run_search_strategy": args.search_strategy,
                "run_score_metric": args.score_metric,
                "run_include_accumulate": args.include_accumulate,
                "run_buffer_candidates": "|".join(str(c) for c in candidates),
                "best_buffer": best_buffer,
    ...
    csv_fields = [
        ...
        "run_search_strategy",
        "run_score_metric",
        "run_include_accumulate",
        "run_buffer_candidates",
        "best_buffer",
        "best_dynamic_score",
        "drift_rate_deg_min",
